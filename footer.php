						...
						<div class="row">
							...
							<div class="footer-column col-xl-5 col-lg-5 col-md-6 col-sm-12">
								<div class="footer-widget about-widget">
									...
									<div class="text">As committed providers of fresh fruits and vegetables for export. With a well-established global clientele, we take pride in our commitment to delivering the best.</div>
					...
					<div class="auto-container">
						<div class="inner-container">
							<div class="copyright-text">
								<p>&copy; Copyright 2024 by <a href="index.php">Asif Global Export</a></p>
							</div>
						</div>
					</div>
				</div>

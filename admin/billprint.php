      ...
      <tr>
        <td colspan='1' rowspan='1' valign='top' style='font-style:normal;font-weight:normal;font-stretch:normal;font-size:14px;line-height:normal;padding:11px 26px 14px;width:280px;'>
          <p style='margin:2px 0;line-height: 18px;'> 
            <strong> Asif Global   <br> <br clear='none'> No 7/3 Richmond Town, Serpentine Street, Richmond Town, 560025, Bangalore 
      ...
      <tr>
        <td colspan='2' rowspan='1' style='width:640px;'>
          ...
          <p style='margin:4px 0px 4px 20px;width:640px;font-size:16px;    line-height: 21px;
            font-style: italic;
            font-weight: bold;'>Thank you for shopping with Asif Global  . We’re happy to let you know that your order has been dispatched and is on its way to you.  </p>
        </td>
      </tr>
      <tr>
...
<tr>
  <td colspan='2' rowspan='1' style='padding:0 20px 0 20px;line-height:22px;width:640px;'>
    <p style='border-top:1px solid #ccc;padding:20px 0 0 0;'>Track your order with the <a rel='nofollow' shape='rect' target='_blank' href='' style='color:#d93e7b;text-decoration:none;'><b> Asif Global  </b></a>.

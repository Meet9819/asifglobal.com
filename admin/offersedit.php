...
<?php
    ...
    if(isset($_POST['btn_save_updates']))
    {
        ...
        if($imgFile)
        {
            ...
            $valid_extensions = array('pdf', 'jpg', 'png', 'gif'); // valid extensions
...
?>
                            ...
                            <div class="form-group">
                                <label for="inp-type-1" class="col-sm-3 control-label">Document </label>
                                <div class="col-sm-6">
  ...
  <input type="file" name="user_image" accept="*" />
                                ...
                                <p class="help-block">document should be <?php echo $size; ?> in pixels</p>
                                </div>
